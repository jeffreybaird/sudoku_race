defmodule SudokuRaceWeb.Router do
  use SudokuRaceWeb, :router

  import SudokuRaceWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {SudokuRaceWeb.Layouts, :root}
  ...
  # scope "/api", SudokuRaceWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:sudoku_race, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: SudokuRaceWeb.Telemetry
  ...
  scope "/", SudokuRaceWeb do
    ...
    live_session :current_user,
      on_mount: [{SudokuRaceWeb.UserAuth, :mount_current_scope}] do
